...
const spellData = {
  [SCHOOL_CHRONOMANCER]: {
    ...
    schoolAdjustment: {
      aligned: [ SCHOOL_ELEMENTALIST, SCHOOL_NECROMANCER, SCHOOL_SOOTHSAYER ],
      opposed: [ SCHOOL_ENCHANTER ],
    },
  ...
  [SCHOOL_ELEMENTALIST]: {
    ...
    schoolAdjustment: {
      aligned: [ SCHOOL_CHRONOMANCER, SCHOOL_ENCHANTER, SCHOOL_SUMMONER ],
      opposed: [ SCHOOL_ILLUSIONIST ],
    },
    ...
    spells: {
      ...
      'Elemental Lash': {
        ...
        castingNumber: 12,
        text: 'This spell may be cast whenever an enemy figure comes with in 1" of the spellcaster. The caster makes a +3 shooting attack against the target. If the spell does at least one point of damage, the target is move 1" directly away from the caster, its movement ends, and any additional actions it had are lost.',
        expansion: EXPANSION_INTO_THE_BREEDING_PITS,
      },
    },
  },
  ...
  [SCHOOL_ENCHANTER]: {
    ...
    schoolAdjustment: {
      aligned: [ SCHOOL_ELEMENTALIST, SCHOOL_SIGILIST, SCHOOL_WITCH ],
      opposed: [ SCHOOL_CHRONOMANCER ],
    },
  ...
  [SCHOOL_ILLUSIONIST]: {
    ...
    schoolAdjustment: {
      aligned: [ SCHOOL_SIGILIST, SCHOOL_SOOTHSAYER, SCHOOL_THAUMATURGE ],
      opposed: [ SCHOOL_NECROMANCER ],
    },
  ...
  [SCHOOL_NECROMANCER]: {
    ...
    schoolAdjustment: {
      aligned: [ SCHOOL_CHRONOMANCER, SCHOOL_SUMMONER, SCHOOL_WITCH ],
      opposed: [ SCHOOL_THAUMATURGE ],
    },
  ...
  [SCHOOL_SIGILIST]: {
    ...
    schoolAdjustment: {
      aligned: [ SCHOOL_CHRONOMANCER, SCHOOL_THAUMATURGE, SCHOOL_ILLUSIONIST ],
      opposed: [ SCHOOL_SUMMONER ],
    },
  ...
  [SCHOOL_SUMMONER]: {
    ...
    schoolAdjustment: {
      aligned: [ SCHOOL_WITCH, SCHOOL_NECROMANCER, SCHOOL_ELEMENTALIST ],
      opposed: [ SCHOOL_SIGILIST ],
    },
  ...
  [SCHOOL_THAUMATURGE]: {
    ...
    schoolAdjustment: {
      aligned: [ SCHOOL_SOOTHSAYER, SCHOOL_SIGILIST, SCHOOL_ILLUSIONIST ],
      opposed: [ SCHOOL_NECROMANCER ],
    },
  ...
  [SCHOOL_WITCH]: {
    ...
    schoolAdjustment: {
      aligned: [ SCHOOL_NECROMANCER, SCHOOL_ENCHANTER, SCHOOL_SUMMONER ],
      opposed: [ SCHOOL_SOOTHSAYER ],
    },
  ...
  [SCHOOL_SPIRITUALIST]: {
    ...
    schoolAdjustment: {
      aligned: [ SCHOOL_NECROMANCER, SCHOOL_THAUMATURGE ],
      opposed: [],
    },
  ...
  [SCHOOL_ASTROMANCER]: {
    ...
    schoolAdjustment: {
      aligned: [ SCHOOL_ELEMENTALIST, SCHOOL_SIGILIST ],
      opposed: [],
    },
  ...
  [SCHOOL_VAMPIRE]: {
    ...
    schoolAdjustment: {
      aligned: [ SCHOOL_CHRONOMANCER, SCHOOL_NECROMANCER, SCHOOL_SOOTHSAYER ],
      antithetical: [ SCHOOL_THAUMATURGE ],
    },
  ...
  [SCHOOL_FIRE_GIANT]: {
    ...
    schoolAdjustment: {
      aligned: [ SCHOOL_ELEMENTALIST, SCHOOL_ENCHANTER, SCHOOL_SOOTHSAYER ],
      antithetical: [ SCHOOL_CHRONOMANCER ],
    },
    ...
    spells: {
      ...
      'Earthquake': {
        range: RANGE_AREA,
        castingNumber: 12,
        text: 'The caster pounds the ground and sends a massive shock wave rolling through the earth. Every figure within 8” of the caster (but not the caster) must make an immediate Move Roll (TN20). Large creatures get +2 to this roll. If it fails, it is knocked prone. While prone, a figure is a -2 Fight, -2 Shoot, and -2 to all Casting Rolls and may not take a Move action. A figure can get back to their feet simply by spending a Move action. This requires the full move action.'
      },
      'Enflame': {
        range: RANGE_LOS,
        castingNumber: 8,
